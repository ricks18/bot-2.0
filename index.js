...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:Ricks\n' // Seu nome
            + 'ORG:SHUREK;\n' // Nome do Bot
            + 'TEL;type=CELL;type=VOICE;waid=5521997112002:+55 21 99711-2002\n' // Numero do Whatsapp
            + 'END:VCARD'
prefix = '!'
blocked = []
limitawal = '999999999'
 ...
 async function starts() {
	...
	const mdata = await client.groupMetadata(anu.jid)
			if (anu.action == 'add'){
				...
				if(!num.split('@')[0].startsWith(55)) {
					client.sendMessage(mdata.id, 'Você está com um número estrangeiro, ou seja, não é bem vindo neste grupo!️', MessageType.text)
	...
	client.on('chat-update', async (mek) => {
      ...
      pushname2 = client.contacts[nameReq] != undefined ? client.contacts[nameReq].vname || client.contacts[nameReq].notify : undefined
			...
			mess = {
					wait: '⏳Processando... Caso falhar, encie novamente em 1 minuto!',
					success: 'Pronto!✔️',
					...
					levelnol: '*ERROR* °-°',
					error: {
				stick: 'Não foi possível converter a foto/video em figurinha! :/',
				Iv: 'Link invalido❌'
				},
				only: {
					group: '📌 Este comando pode ser usados apenas em grupos!',
					premium: `Ei ${pushname2}! Apenas usuários premiums podem usar esse comando...*`,
					mod: '*Este comando pode ser usado apenas por usuários mods! Sinto muito... :/*',
					benned: '❌ Você foi banido por quebrar alguma regra, contate o dono para te desbanir',
					ownerG: 'Apenas o dono do grupo pode usar esse comando',
					ownerB: '❌ Este comando só pode ser usado pelo dono do bot! :)',
					rik: 'Apenas o dono do bot pode usar este comando, ele pode causar ban no número do bot',
					userB: `──「 LISTA 」──\nOlá ${pushname} !\nVocê não esta registrado como amigo do meu dono então peça para ele te adicionar como amigo\n\n──「 ⚓ SHUREK BOT ⚓ 」──`,
			...
			const ownerNumber = ["5521997112002@s.whatsapp.net","5511974980928@s.whatsapp.net","552197112002@s.whatsapp.net"] // Recoloque o seu numero
			const rik = ["5521997112002@s.whatsapp.net","5511974980928@s.whatsapp.net"]
			const mod = [ownerNumber,"5521997112002@s.whatsapp.net","551974980928@s.whatsapp.net","552197112002@s.whatsapp.net"]// Moderador do bot
			const adminbotnumber = ["5521997112002@s.whatsapp.net","551974980928@s.whatsapp.net","552197112002@s.whatsapp.net"]// admin bot numero
			const frendsowner = ["5521997112002@s.whatsapp.net","551974980928@s.whatsapp.net","552197112002@s.whatsapp.net"]// amigo do criador 
			const premium = ["5521997112002@s.whatsapp.net","584167147895@s.whatsapp.net","5491130465477@s.whatsapp.net","551974980928@s.whatsapp.net","558981204807@s.whatsapp.net","5511974980928@s.whatsapp.net","554999498331@s.whatsapp.net","552197112002@s.whatsapp.net","552197112002@s.whatsapp.net"]
			...
			const isrik = rik.includes(sender)
		...
		const arg = chats.slice(command.length + 2, chats.length)
			...
			const costum = (persan, tipe, target, target2) => {
			client.sendMessage(from, persan, tipe, {quoted: { key: { fromMe: false, participant: `${target}`,...(from ? { remoteJid: from } : {}) }, message: { conversation: `${target2}` }}})
			}
              //function leveling
  ...
  conn.sendMessage(id, hasil, MessageType.text); 
	...
	if (messagesC.includes("fdp")){
		...
		if (messagesC.includes("*meliodas")){
			...
			if (messagesC.includes("baaah")){
			client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./assets/bahc.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
	}
	
			if (messagesC.includes("merrrmao")){
			client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./assets/irmao.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
	}
		
			if (messagesC.includes("tmmnc")){
			client.updatePresence(from, Presence.composing)
			...
			client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./assets/menuzin.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
	}
	
			if (messagesC.includes("@551974980928")){
			client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./assets/chapa.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
	}
	
			if (messagesC.includes("ricks")){
			client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./assets/ricks.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
	}

			if (messagesC.includes("membuat")){
			client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./assets/oibot.m4a');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
	}
	
			if (messagesC.includes("Dbbz")){
			client.updatePresence(from, Presence.composing)
          ...
          if (messagesC.includes("sexo")){
			client.updatePresence(from, Presence.composing) 
	     	const d = fs.readFileSync('./sticker/sexo.webp');
            client.sendMessage(from, d, sticker, {quoted: mek})
    }
  /*        if (messagesC.includes("qual")){
			client.updatePresence(from, Presence.composing) 
	     	const d = fs.readFileSync('./sticker/teste.webp');
            client.sendMessage(from, d, sticker, {quoted: mek})
    }
          if (messagesC.includes("quando")){
			client.updatePresence(from, Presence.composing) 
	     	const d = fs.readFileSync('./sticker/teste.webp');
            client.sendMessage(from, d, sticker, {quoted: mek})
    }
          if (messagesC.includes("que")){
			client.updatePresence(from, Presence.composing) 
	     	const d = fs.readFileSync('./sticker/teste.webp');
            client.sendMessage(from, d, sticker, {quoted: mek})
    }
          if (messagesC.includes("onde")){
			client.updatePresence(from, Presence.composing) 
	     	const d = fs.readFileSync('./sticker/teste.webp');
            client.sendMessage(from, d, sticker, {quoted: mek})
    }
          if (messagesC.includes("favor")){
			client.updatePresence(from, Presence.composing) 
	     	const d = fs.readFileSync('./sticker/teste.webp');
            client.sendMessage(from, d, sticker, {quoted: mek})
    }
          if (messagesC.includes("acaso")){
			client.updatePresence(from, Presence.composing) 
	     	const d = fs.readFileSync('./sticker/teste.webp');
            client.sendMessage(from, d, sticker, {quoted: mek})
    }
          if (messagesC.includes("foi")){
			client.updatePresence(from, Presence.composing) 
	     	const d = fs.readFileSync('./sticker/teste.webp');
            client.sendMessage(from, d, sticker, {quoted: mek})
    }
          if (messagesC.includes("chance")){
			client.updatePresence(from, Presence.composing) 
	     	const d = fs.readFileSync('./sticker/teste.webp');
            client.sendMessage(from, d, sticker, {quoted: mek})
    }
          if (messagesC.includes("chances")){
			client.updatePresence(from, Presence.composing) 
	     	const d = fs.readFileSync('./sticker/teste.webp');
            client.sendMessage(from, d, sticker, {quoted: mek})
    }
          if (messagesC.includes("quais")){
			client.updatePresence(from, Presence.composing) 
	     	const d = fs.readFileSync('./sticker/teste.webp');
            client.sendMessage(from, d, sticker, {quoted: mek})
    }
          if (messagesC.includes("possibilidade")){
			client.updatePresence(from, Presence.composing) 
	     	const d = fs.readFileSync('./sticker/teste.webp');
            client.sendMessage(from, d, sticker, {quoted: mek})
    }
          if (messagesC.includes("alguém")){
			client.updatePresence(from, Presence.composing) 
	     	const d = fs.readFileSync('./sticker/teste.webp');
            client.sendMessage(from, d, sticker, {quoted: mek})
    }
          ...
          if (messagesC.includes("talvez")){
			client.updatePresence(from, Presence.composing) 
	     	const d = fs.readFileSync('./sticker/teste.webp');
            client.sendMessage(from, d, sticker, {quoted: mek})
    }
          if (messagesC.includes("sei")){
			client.updatePresence(from, Presence.composing) 
	     	const d = fs.readFileSync('./sticker/teste.webp');
            client.sendMessage(from, d, sticker, {quoted: mek})
    }
          if (messagesC.includes("desconheço")){
			client.updatePresence(from, Presence.composing) 
	     	const d = fs.readFileSync('./sticker/teste.webp');
            client.sendMessage(from, d, sticker, {quoted: mek})
    }
          if (messagesC.includes("por")){
			client.updatePresence(from, Presence.composing) 
	     	const d = fs.readFileSync('./sticker/teste.webp');
            client.sendMessage(from, d, sticker, {quoted: mek})
    } */
    ...
    /*      if (messagesC.includes("cianci")){
			client.updatePresence(from, Presence.composing) 
	     	const d = fs.readFileSync('./sticker/cianci.webp');
            client.sendMessage(from, d, sticker, {quoted: mek})
    }
          if (messagesC.includes("joão")){
			client.updatePresence(from, Presence.composing) 
	     	const d = fs.readFileSync('./sticker/joao.webp');
            client.sendMessage(from, d, sticker, {quoted: mek})
    } */
	...
	/*          if (messagesC.includes("cesar")){
			client.updatePresence(from, Presence.composing) 
	     	const d = fs.readFileSync('./sticker/cesar.webp');
            client.sendMessage(from, d, sticker, {quoted: mek})
    } 
          if (messagesC.includes("luis")){
			client.updatePresence(from, Presence.composing) 
	     	const d = fs.readFileSync('./sticker/luis.webp');
            client.sendMessage(from, d, sticker, {quoted: mek})
    }

	if (messagesC.includes("xanddao")){
			client.updatePresence(from, Presence.composing) 
	     	const d = fs.readFileSync('./sticker/pqp.webp');
            client.sendMessage(from, d, sticker, {quoted: mek})
    } */
	
				if (messagesC.includes("caanta")){
			client.updatePresence(from, Presence.composing)
            ...
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
				...
				if (messagesC.includes("mandememme")){
			client.updatePresence(from, Presence.composing)
			...
			switch(command) {
	            ...
	            case 'help':
                    ...
                    putagg = await getBuffer(`https://i.ibb.co/GMyr50p/Pics-Art-05-25-04-55-54.jpg`)
                    client.sendMessage(from, help(prefix, sender, pushname, time) , text, {quoted: mek, quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "𝑺𝑯𝑼𝑹𝑬𝑲 𝑩𝑶𝑻 ☂︎", 'jpegThumbnail': fs.readFileSync('kk/sticker/botlogo.webp')}}}})
...
wew = fs.readFileSync('./assets/foto.png')
                client.sendMessage(from, wew, image, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg", "caption": "𝑺𝑯𝑼𝑹𝑬𝑲 𝑩𝑶𝑻 ☂", "fileSha256": "+Ia+Dwib70Y1CWRMAP9QLJKjIJt54fKycOfB2OEZbTU=", "fileLength": "28777", "height": 1080, "width": 1079, "mediaKey": "vXmRR7ZUeDWjXy5iQk17TrowBzuwRya0errAFnXxbGc=", "fileEncSha256": "sR9D2RS5JSifw49HeBADguI23fWDz1aZu4faWG/CyRY=", "directPath": "/v/t62.7118-24/21427642_840952686474581_572788076332761430_n.enc?oh=3f57c1ba2fcab95f2c0bb475d72720ba&oe=602F3D69", "mediaKeyTimestamp": "1610993486", "jpegThumbnail": fs.readFileSync('./assets/botlogo.webp')} } }, caption: help(prefix) })
				  break */
                case 'musica':
                case 'msc':
                client.sendMessage(from, msc(prefix, sender, pushname, time) , text, {quoted: mek, quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "𝑺𝑯𝑼𝑹𝑬𝑲 𝑩𝑶𝑻 ☂︎", 'jpegThumbnail': fs.readFileSync('kk/sticker/botlogo.webp')}}}})
                break
                case 'euuu':
				...
				case 'menu1':
					...
					costum(help1(prefix), text, tescuk, cr)
					break
				case 'pau':
				...
				teks = `Hey ${pushname} esses são os caras com o menor e maior pau do grupo: [ ${groupName} ]\n\n@${paus1.jid.split('@')[0]}\n${pc1}\n\n🙅🏽├>@${paus2.jid.split('@')[0]}\n${pc2}\n\n🙅🏽├>@${paus3.jid.split('@')[0]}\n${pc3}\n\n🙅🏽├>@${paus4.jid.split('@')[0]}\n${pc4}\n\n🙅🏽├>@${paus5.jid.split('@')[0]}\n${pc5}\n\n⚓ Shurek Bot⚓`
				...
				mentions(teks, membr, true)
					break
				case 'otakus':
					if (!isGroup) return reply(`Comando so pode ser utiizado em grupos.`)
					membr = []
					...
					teks = `Ei ${pushname} esses são os otakus fedidos do grupo: [ *${groupName}* ]\n\n\n🇯🇵├>@${otakus1.jid.split('@')[0]}\n\n🇯🇵├>@${otakus2.jid.split('@')[0]}\n\n🇯🇵├>@${otakus3.jid.split('@')[0]}\n\n🇯🇵├>@${otakus4.jid.split('@')[0]}\n\n🇯🇵├>@${otakus5.jid.split('@')[0]}\n\n🇯🇵├>@${otakus6.jid.split('@')[0]}\n\n🇯🇵├>@${otakus7.jid.split('@')[0]}\n\n🇯🇵├>@${otakus8.jid.split('@')[0]}\n\n🇯🇵├>@${otakus9.jid.split('@')[0]}\n\n🇯🇵├>@${otakus10.jid.split('@')[0]}\n\nShurek-BOT`
				...
				reply(`${pushname} esse e o link da git do ⚓ Shurek Bot⚓`)
				}, 1000)
					break
	/*			case 'install':
			reply(`Aqui os comandos do ⚓ Shurek Bot⚓ ${pushname}`)
			setTimeout( () => {
			client.sendMessage(from, Presence.composing)
			...
			setTimeout( () => {
				...
				reply("npm start")
					...
					break
					case 'gays':
					if (!isGroup) return reply(`Esse comando so pode ser usadoem grupos.`)
					membr = []
					...
					const porcentagem2 = porcentagemgay[Math.floor(Math.random() * porcentagemgay.length)]
                    const porcentagem3 = porcentagemgay[Math.floor(Math.random() * porcentagemgay.length)]
                    const porcentagem4 = porcentagemgay[Math.floor(Math.random() * porcentagemgay.length)]
                    const porcentagem5 = porcentagemgay[Math.floor(Math.random() * porcentagemgay.length)]
					teks = `${pushname}, esses são os mais SuperGays do grupo: *[ ${groupName} ]*\n\n🏳️‍🌈├>@${gays1.jid.split('@')[0]}\nCom uma porcentagem de ${porcentagem}\n🏳️‍🌈├>@${gays2.jid.split('@')[0]}\nCom uma porcentagem de ${porcentagem2}\n🏳️‍🌈├>@${gays3.jid.split('@')[0]}\nCom uma porcentagem de ${porcentagem3}\n🏳️‍🌈├>@${gays4.jid.split('@')[0]}\nCom uma porcentagem de ${porcentagem4}\n🏳️‍🌈├>@${gays5.jid.split('@')[0]}\nCom uma porcentagem de ${porcentagem5}\n\n Shurek-BOT`
					...
					const porcentagemc2 = porcentagemcorno[Math.floor(Math.random() * porcentagemcorno.length)]
					const porcentagemc3 = porcentagemcorno[Math.floor(Math.random() * porcentagemcorno.length)]
					const porcentagemc4 = porcentagemcorno[Math.floor(Math.random() * porcentagemcorno.length)]
					const porcentagemc5 = porcentagemcorno[Math.floor(Math.random() * porcentagemcorno.length)]
					teks = `${pushname}, esses são os cornos do grupo: *[ ${groupName} ]*\n==>@${cornos1.jid.split('@')[0]}\nCom uma porcentagem de ${porcentagemc}\n\n==>@${cornos2.jid.split('@')[0]}\nCom uma porcentagem de ${porcentagemc2}\n\n==>@${cornos3.jid.split('@')[0]}\nCom uma porcentagem de ${porcentagemc3}\n\n==>@${cornos4.jid.split('@')[0]}\nCom uma porcentagem de ${porcentagemc4}\n\n==>@${cornos5.jid.split('@')[0]}\nCom uma porcentagem de ${porcentagemc5}\n\n 
				Shurek-BOT`
...
break
                   case 'gados':
					...
					teks = `Ei ${pushname}, esses são os gados fedidos do grupo: *[ ${groupName} ]*\n\n🐂├>@${gados1.jid.split('@')[0]}\n\n🐂├>@${gados2.jid.split('@')[0]}\n\n🐂├>@${gados3.jid.split('@')[0]}\n\n🐂├>@${gados4.jid.split('@')[0]}\n\n🐂├>@${gados5.jid.split('@')[0]}\n\n🐂├>@${gados6.jid.split('@')[0]}\n\n🐂├>@${gados7.jid.split('@')[0]}\n\n🐂├>@${gados8.jid.split('@')[0]}\n\n🐂├>@${gados9.jid.split('@')[0]}\n\n🐂├>@${gados10.jid.split('@')[0]}\n\nShurek-BOT`
...
case 'plaquinha':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Sucesso ✓'})
					break
				case 'pmake':
					if (args.length < 1) return reply(mess.blank)
					teks = body.slice(7)
...
case 'roletarussa':
				...
				case 'bloquear':
				 ...
				 client.chatRead (from)
					...
					client.sendMessage(from, `Blz esse cara aqui ja foi bloqueado ${body.slice(7)}@c.us`, text)
					break
				case 'premiumlist':
					teks = '╭────*「 *PREMIUM USER👑* 」\n'
...
teks += `🤩❧ @${groupMembers[r2].jid.split('@')[0]}\n`
d.push(groupMembers[r2].jid)
}
mentions(teks, d, true)
} catch (e) {
console.log(e)
...
for(i = 0; i < 5; i++) {
r3 = Math.floor(Math.random() * groupMetadata.participants.length + 0)
teks += `🤓❧ @${groupMembers[r3].jid.split('@')[0]}\n`
d.push(groupMembers[r3].jid)
}
mentions(teks, d, true)
} catch (e) {
console.log(e)
...
break
                case 'exif':
				if (args.length < 1) return fdciabdul.reply(from, `Penggunaan ${prefix}exif nama|author`, mek)
				if (!arg.split('|')) return fdciabdul.reply(from, `Penggunaan ${prefix}exif nama|author`, mek)
				exif.create(arg.split('|')[0], arg.split('|')[1])
				fdciabdul.reply(from, 'sukses', mek)
				break
				case 'animekiss':
                if (!isAnime) return reply(' *Deve ativar o modo Anime* ')
					anp = getRandom('.gif')
	...
	/*			case 'setfoto':
				...
				case 'wibu':
                   ...
                   break
					case 'usuarios':
					if (!isOwner) return reply(mess.only.ownerB)    
					teks = `\`\`\`╭────*「 *TOTAL DE USUÁRIOS ⚓ Shurek Bot⚓* 」\n\`\`\``
					no = 0
...
/*			case 'closegc':
				...
				case 'kurumi':
                    ...
                    if (mentioned.length > 1) {
                        ...
                        mentions(`Hmmmm, @${sender.split('@')[0]} deu um beijo em @${mentioned[0].split('@')[0]} `, mentioned, true)
                        client.sendMessage(from, mentioned)
                    }
                    break
                    case 'sekisu':
                    ...
                    if (mentioned.length > 1) {
                        ...
                        mentions(`Eita, @${sender.split('@')[0]} fez sexo com @${mentioned[0].split('@')[0]} . Quem será o filho? `, mentioned, true)
                        client.sendMessage(from, mentioned)
                    }
                    break
				case 'miku':
             ...
             /*   case 'bug':
               ...
               case 'coffee':
				...
				case 'stickerlist':
					...
					teks += `\n*Total : ${setiker.length}*\n\n\n*Para pegar alguma figurinha, digite !getfigu e o nome da figurinha*`
				...
				case 'addfigu':
					...
					client.sendMessage(from, `Adicionando adesivo com sucesso\nVerificar pelo comando:  *${prefix}listafigu*`, MessageType.text, { quoted: mek })
					break			
				case 'addaud':
					if (!isQuotedAudio) return reply('Marque o Audio e coloque o nome dele!')
					svst = body.slice(7)
...
break
          ...
          reply('Espere..')
				...
				case 'bloqueados':
					...
					break
                case 'cred':
                    if (args.length < 1) return reply ('Base: *Darkk, Causs e Meliodas*\n')
				case 'leens':
					if ((isMedia && !mek.message.videoMessage || isQuotedImage) && args.length == 0) {
						const encmedia = isQuotedImage ? JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo : mek
						const media = await client.downloadAndSaveMediaMessage(encmedia)
...
case 'swm':
			case 'stickerwm':
				if (isMedia && !mek.message.videoMessage || isQuotedImage) {
					if (!arg.includes('|')) return client.reply(from, `Kirim gambar atau reply gambar dengan caption *${prefix}stickerwm nama|author*`, mek)
					const encmedia = isQuotedImage ? JSON.parse(JSON.stringify(mek).replace('quotedM', 'm')).message.extendedTextMessage.contextInfo : mek
					...
					await ffmpeg(`${media}`)
							...
							.on('error', function (err) {
								console.log(`Error : ${err}`)
								fs.unlinkSync(media)
								client.reply(from, mess.error.api, mek)
							})
							.on('end', function () {
								console.log('Finish')
								exec(`webpmux -set exif ./sticker/stickwm_${sender}.exif ./sticker/${sender}.webp -o ./sticker/${sender}.webp`, async (error) => {
									if (error) return client.reply(from, mess.error.api, mek)
					...
					const author1 = arg.split('|')[1]
					exif.create(packname1, author1, `stickwm_${sender}`)
					client.reply(from, mess.wait, mek)
						await ffmpeg(`${media}`)
					...
					client.reply(from, `Kirim gambar/video dengan caption ${prefix}stickerwm nama|author atau tag gambar/video yang sudah dikirim\nNote : Durasi video maximal 10 detik`, id)
				}
				break
/*case 'stickergif':
case 'stikergif':
...
.on('end', function () {
console.log('Finish')
//exec(`webpmux -set exif ${addMetadata('Shurek-BOT', 'Italu')} ${ran} -o ${ran}`, async (error) => {
...
exec(`webpmux -set exif ${addMetadata('Shurek-BOT', 'Italu')} ${ranw} -o ${ranw}`, async (error) => {
if (error) return reply(ptbr.stick())
client.sendMessage(from, fs.readFileSync(ranw), sticker, {quoted: mek})
fs.unlinkSync(ranw)
})
...
client.sendMessage('5521997112002@s.whatsapp.net', options, text, {quoted: mek})
...
break
            ...
            /*    case 'hidetag':
				...
				case 'walpaperanime':
					...
					break
					case 'dado':    
					if (!isPremium) return reply('Você não é um Membro Premium, entre em contato com o dono ou digite *.Daftarvip* para adquirir o acesso Premium!' ,text, { quoted: mek })
			...
			/*	case 'canal':
				...
				case 'dono':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://i.imgur.com/t9cfJ7M.jpg`)
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '*DONO:* Henrique\n*Número:* wa.me/5521997112002'})
					break
				/*case 'dono2':
					memein = await kagApi.memeindo()
        ...
        case 'promover':
				...
				case 'kick' :
					if (!isGroup) return reply(mess.only.group)
          if (!isrik) return reply(mess.only.rik)
					if (!isGroupAdmins) return reply(mess.only.admin)
					if (!isBotGroupAdmins) return reply(mess.only.Badmin)
					if (mek.message.extendedTextMessage === undefined || mek.message.extendedTextMessage === null) return reply('A marca-alvo que você quer chutar!')
					mentioned = mek.message.extendedTextMessage.contextInfo.mentionedJid
